...
<h1>
	Update/delete admin user '<c:out value="${adminUser.username}" />'
</h1>
...
<c:url value="/admin/adminupdate" var="formAction"/>
<form:form method="POST" modelAttribute="adminUser" action="${formAction}" cssClass="form-horizontal top50" role="form" id="adminForm">
	<fieldset>
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				<input type="password" class="form-control" name="passwordConfirmation" value="<c:out value="${adminUser.password}" />" />
			</div>
		</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>Are you sure you want to delete <c:out value="${adminUser.firstName} ${adminUser.lastName}" /> admin user?</p>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
				<a href='<s:url value="/admin/admindelete/${adminUser.username}" />' 
