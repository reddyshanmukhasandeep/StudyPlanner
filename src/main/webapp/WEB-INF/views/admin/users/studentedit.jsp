...
<h1>
	Update/delete student user '<c:out value="${studentUser.username}" />'
</h1>
...
<c:url value="/admin/studentupdate" var="formAction"/>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>Are you sure you want to delete <c:out value="${studentUser.firstName} ${studentUser.lastName}" /> student user?</p>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
				<a href='<s:url value="/admin/studentdelete/${studentUser.username}" />' 
